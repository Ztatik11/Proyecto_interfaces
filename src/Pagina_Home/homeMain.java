...
public class homeMain extends JFrame {
    ...
    public static void creacion_tablas(consultas_sql conexion_db) throws SQLException{
       ...
       conexion_db.creacion_tabla( "imagenes", "ID int NOT NULL AUTO_INCREMENT,Nombre char(100),Imagen longblob,ID_juego int,Constraint fk_ID_juego_imagenes foreign key (ID_juego) references juegos(ID),primary key(ID)");
